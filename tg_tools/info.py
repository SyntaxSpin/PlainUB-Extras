    ...
    if is_full:
        ...
        try:
            if message.chat.type in [ChatType.GROUP, ChatType.SUPERGROUP]:
                ...
                status_map = {
                    ...
                    ChatMemberStatus.LEFT: "Not in chat", ChatMemberStatus.BANNED: "Banned"
                }
        ...
        try:
            if message.chat.type in [ChatType.GROUP, ChatType.SUPERGROUP]:
                member = await bot.get_chat_member(message.chat.id, user.id)
                status_map = {
                    ChatMemberStatus.OWNER: "Owner", ChatMemberStatus.ADMINISTRATOR: "Admin",
                    ChatMemberStatus.MEMBER: "Member", ChatMemberStatus.RESTRICTED: "Muted",
