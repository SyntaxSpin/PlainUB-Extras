...
async def cancel_handler(bot: BOT, message: Message):
    ...
    except (ValueError, KeyError): await message.edit("Invalid Job ID.", del_in=ERROR_VISIBLE_DURATION)async def _download_torrent(link: str, msg: Message, job_id: int):
